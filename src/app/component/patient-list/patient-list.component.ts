...
import { NbTreeGridDataSource, NbTreeGridDataSourceBuilder, NbSortRequest, NbSortDirection } from '@nebular/theme';
...
export class PatientListComponent implements OnInit {
  ...
  // displayedColumns: string[] = ['patientName', 'date', 'status', 'action'];
...
private data: TreeNode<FSEntry>[] = [
  ...
  //   this.dataSource.sortingDataAccessor = (item: Patient, property): string | number => {
  //     switch (property) {
  //       case 'date': return new Date(item.query.date).getTime();
